...
Payout ratio anchoring:
  ...
  Payout ratio anchor rule:
    If company has a committed/stated dividend policy → Use committed payout ratio
    If no commitment but stable history → Use 3-year trailing average (M)
    If no commitment and volatile history → Use 3-year trailing average (M) with caution
...
*US Equity Turtle Strategy v2.0 | Factor 2 Reference File*
