...
Refined Penetration Return Rate (→ See shared_tables.md §T5 for formula):
  GG = [AA × M_anchor × (1 − Q) + O] / Market_Cap × 100
  Q = 15% (→ See shared_tables.md §T2)
  = [value]% (GG)
...
*US Equity Quality Yield Strategy v2.0 | Factor 3 Reference File*
